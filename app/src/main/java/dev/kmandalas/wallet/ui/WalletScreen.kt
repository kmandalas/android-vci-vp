package dev.kmandalas.wallet.ui
...
fun WalletScreen(
    ...
    LaunchedEffect(intent) {
        if (intent?.data != null) {
            ...
            (activity as? dev.kmandalas.wallet.MainActivity)?.currentIntent?.value = null
        }
    }
        ...
        Box(
            ...
            Column(
                ...
                if (posture.level != null &&
                    posture.level != dev.kmandalas.wallet.security.SecurityPostureLevel.LEVEL_1 &&
                    posture.level != dev.kmandalas.wallet.security.SecurityPostureLevel.LEVEL_4
                ) {
                    val bgColor = if (posture.level == dev.kmandalas.wallet.security.SecurityPostureLevel.LEVEL_3)
                    ...
                    Surface(
                        ...
                        Text(
                            ...
                            color = if (posture.level == dev.kmandalas.wallet.security.SecurityPostureLevel.LEVEL_3)
